...
class pagination extends HTMLElement {
    ...
    myScroll() {
      let lastScrollTop = 0;
      // let listElm = document.querySelector('#product-grid');
      // let loadMorePos = this.loadMoreButton.offsetTop;
      // var currentScrollTop =  window.scrollY;
      // if (currentScrollTop + window.innerHeight > loadMorePos && currentScrollTop > lastScrollTop) {
